...
#define CHANNEL_PER_MCKEY             (0)  /**< Number of channels per key (possible values are 5 or 8 only) */
...
// Thresholds
#define SCKEY_DETECTTHRESHOLD_DEFAULT          (5)  /**< Single channel key detection threshold (value from 1 to 127 def12) */
#define SCKEY_ENDDETECTTHRESHOLD_DEFAULT        (3)  /**< Single channel key end detection threshold (value from 1 to 127 def 8) */
...
#define SCKEY_MIN_ACQUISITION    (20) /**< Single channel key minimum acquisition value  def  50*/
#define SCKEY_MAX_ACQUISITION  (5000) /**< Single channel key maximum acquisition value */
